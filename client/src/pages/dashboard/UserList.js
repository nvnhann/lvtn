...
import { putData, getData } from '../../_helper/httpProvider';
...
export default function UserList() {
    ...
    (async () => {
      try {
        const res = await getData(
          API_BASE_URL + `/api/users?search=${filterName}`,
        );
        setUsers(res.data);
      } catch (e) {
        console.log(e);
  ...
  const changeActiveUser = async (id, active) => {
    try {
      const res = await putData(API_BASE_URL + '/api/user-active', {
        id: id,
        active: active,
      });
      setLoad((e) => e + 1);
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">
                            ...
                            {!isAdmin && (
                              <Typography>{active ? 'Hiện' : 'Ần'}</Typography>
                            )}
                          </TableCell>
